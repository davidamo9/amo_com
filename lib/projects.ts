...
export const projects: Project[] = [
  {
    ...
    githubUrl: "https://github.com/aungmyintoo/optics-framework",
    featured: true,
  },
  {
    id: "atlas",
    ...
    githubUrl: "https://github.com/aungmyintoo/atlas",
    featured: true,
  },
  {
    id: "secondbrain",
    ...
    githubUrl: "https://github.com/aungmyintoo/secondbrain",
    featured: true,
  },
  {
    id: "ai-sales-buddy",
    ...
    githubUrl: "https://github.com/aungmyintoo/ai-sales-buddy",
    featured: true,
  },
  {
    id: "streamflow",
    ...
    longDescription: "StreamFlow AI is a production-ready AI chatbot platform designed for businesses to automate customer interactions with intelligent, context-aware responses. Implements RAG with FAISS vector database for document-grounded answers, supporting multiple LLM providers (OpenAI, Groq). Features privacy-first architecture with explicit user consent for data collection (GDPR/CCPA compliant), bidirectional Membrain CRM integration for automated lead capture, admin panel for document management, and multi-client deployment architecture. Built with React 19 frontend featuring Framer Motion animations and Flask backend deployed on Railway. Includes interactive demo playground, session management, rate limiting, and comprehensive security features.",
    image: "/images/projects/streamflow.jpg",
    tags: ["React", "TypeScript", "Flask", "FAISS", "RAG", "OpenAI", "Groq", "CRM", "Privacy-First"],
    demoUrl: "/streamflow",
    githubUrl: "https://github.com/aungmyintoo/streamflow-ai-platform",
    featured: true,
  },
  {
    id: "refstash",
    title: "RefStash - Reference Management System",
    description: "Full-stack reference management product with Chrome extension for saving and organizing web content. Features JWT authentication, PostgreSQL backend, and production deployment on Railway and Vercel.",
    longDescription: "Complete reference management product featuring three integrated components: FastAPI backend, React frontend, and Chrome browser extension. Enables users to save, organize, and search web references (particularly YouTube videos) with full authentication and user management. Production-ready with Alembic database migrations, automated build scripts for Chrome Web Store submission, comprehensive deployment guides for Railway (backend) and Vercel (frontend). Demonstrates complete product lifecycle from development to production deployment with modern web technologies.",
    image: "/images/projects/refstash.jpg",
    tags: ["FastAPI", "React", "PostgreSQL", "Chrome Extension", "JWT", "Railway", "Vercel"],
